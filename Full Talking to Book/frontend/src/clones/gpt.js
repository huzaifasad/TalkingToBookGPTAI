...
export default function ChatGpt() {
  ...
  return (
    <div className="h-screen w-screen bg-[#181a1d] lg:flex">
      <div  className={`${
          sidebarOpen ? 'fixed' : 'hidden lg:block'
        } w-full lg:w-[20%] bg-[#1d262d] h-screen text-yellow-50 z-50 transition-all duration-300 ease-in-out ${
  ...
  >
    ...
    {uplan === "genius" || uplan === "premium" && (
      ...
      <div className={`w-full lg:w-[80%] bg-[#2a3742] h-[90%] text-white ${sidebarOpen ? 'ml-[20%]' : ''}`}>
...
<option value="Welsh">Welsh</option>
  ...
  {item.content.includes("\\n")
    ...
    : item.content.replace(/\\([\\n])/g, "$1").replace(/\\/g, "")}
      ...
      <button
        className="lg:hidden fixed top-5 left-5 z-50 bg-[#1d262d] text-yellow-50 px-4 py-2 rounded"
